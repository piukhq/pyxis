...
def task_type_key_value(task_type_ids_dict, task_type_keys) -> list:
    task_type_ids = task_type_ids_dict.values()
    task_type_key_values = []
    total_task_types = len(task_type_ids)
    total_task_type_key_values = int(2000 / total_task_types)
    for task_type_id in task_type_ids:
        for task_type_key_id, value in task_type_keys[task_type_id].items():
            id_gen = id_generator(1)
